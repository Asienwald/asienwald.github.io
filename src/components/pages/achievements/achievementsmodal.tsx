...
const AchievementsModal: React.FC = ({}) => {
    ...
    const {isVisible, imageUrl, issueDate, title, issuedBy, descripList} = useSelector((state: AppState) => {
        return state.modal.achievementModal;
    })
                        ...
                        >
                            <div className="row">
                                ...
                                <div className="col-12 col-lg-6 text-left">
                                    <div className="right-view khyay">
